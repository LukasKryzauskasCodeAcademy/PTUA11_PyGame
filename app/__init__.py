...
class CreateApp:
    ...
    def start(self):
        ...
        while run:
            ...
            restart_button = Button(screen, 330, 120, self.drawer.restart_img, 120, 30)
            ...
            if self.game_over != 0:
                if self.game_over == 1:
                    screen.blit(self.drawer.victory_img, (250, 50))
                elif self.game_over == -1:
                    screen.blit(self.drawer.defeat_img, (290, 50))
